...
* config.json of p2pool can be overridden by placing a new config.json on `/p2pool/data/config.json` (via docker-compose override, or manually placing the file).
